const backgroundTree = (version) => {
    ...
    function init() {
        ...
        orangeLight.position.set(300,300,200);
        scene.add(blueLight);
        ...
        loader.load("assets/img/nebula-background-effect-threejs-5.jpg", function(texture){
